package com.myaudiorecorder.services
...
import com.myaudiorecorder.activities.MainActivity
...
class RecorderService : Service() {
    ...
    private fun addFileInNewMediaStore() {
        ...
        if (newUri == null) {
            showErrorToast(R.string.unknown_error_occurred.toString(),Toast.LENGTH_LONG)
            return
        }
    ...
    private fun recordingSavedSuccessfully() {
        showErrorToast(getString(R.string.recording_saved_successfully),Toast.LENGTH_SHORT)
    }
