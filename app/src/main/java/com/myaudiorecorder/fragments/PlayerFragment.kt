...
import com.myaudiorecorder.adapters.RecordingsAdapter
import com.myaudiorecorder.extensions.*
import com.myaudiorecorder.interfaces.RefreshRecordingsListener
...
class PlayerFragment(context: Context, attributeSet: AttributeSet) : MyViewPagerFragment(context, attributeSet),
    ...
    override fun onAttachedToWindow() {
        ...
        bus!!.register(this)
        player_title.text = resources.getString(R.string.no_audio)
        setupColors()
        setupAdapter()
        initMediaPlayer()
        setupViews()
        storePrevPath()
        player_controls_wrapper.visibility = View.GONE
    ...
    private fun setupViews() {
        ...
        hide_player.setOnClickListener {
            player_controls_wrapper.visibility = View.GONE
            now_playing_wrapper.visibility = View.VISIBLE
        }

        now_playing_wrapper.setOnClickListener {
            player_controls_wrapper.visibility = View.VISIBLE
            now_playing_wrapper.visibility = View.GONE
        }
    }
    ...
    private fun setupAdapter() {
        ...
        val adapter = getRecordingsAdapter()
        if (adapter == null) {
            RecordingsAdapter(context as SimpleActivity, recordings,  recordings_list) {
